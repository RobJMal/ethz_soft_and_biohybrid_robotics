...
def createScene(rootNode):
    ...
    cable2_rotation = np.pi/4
    cable2_position = calculate_rotated_matrix(default_cable_position, -1*cable2_rotation)
    cable2_pull_point = calculate_rotated_matrix(default_cable_pull_point, cable2_rotation)

    # cable3_position = calculate_rotated_matrix(default_cable_position, -np.pi/4)
    ...
    # goal2.addObject('MechanicalObject', name='goalMO', position=[103, 7, 7])
    ...
    # effector2.addObject('PositionEffector', template='Vec3', indices=0, effectorGoal="@../../goal2/goalMO.position")
