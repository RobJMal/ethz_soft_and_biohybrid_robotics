...
def createScene(rootNode):
    ...
    print("Falling to the floor...")
    print("Sphere mass before: ", sphere.mass.totalMass.value)
    print("")
    sphere.mass.totalMass.value = 10.0
    print("Sphere mass after: ", sphere.mass.totalMass.value)
